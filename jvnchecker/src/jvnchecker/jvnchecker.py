...
def argparse_setup():
    ...
    parser_product = subparsers.add_parser('product', help='製品名一覧を検索します')
    parser_product.set_defaults(handler=command_product)

    parser_list = subparsers.add_parser('overview', help="脆弱性概要一覧を検索します")
    ...
    parser_list.set_defaults(handler=command_overview)
